...
const LabelPairedCircleExclamationSmRegularIcon = ({ title, titleId, ...props }, ref) => React__namespace.createElement(
  "svg",
  ...
  React__namespace.createElement(
    ...
    React__namespace.createElement(
      "clipPath",
      { id: "7ec48a41a0f41d4b10ca6c581f849435__a" },
      React__namespace.createElement("path", { d: "M0 0h14v22H0z" })
    )
  )
);
const ForwardRef = React.forwardRef(LabelPairedCircleExclamationSmRegularIcon);
