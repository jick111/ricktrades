...
const LabelPairedCircleInfoSmBoldIcon = ({ title, titleId, ...props }, ref) => React__namespace.createElement(
  "svg",
  ...
  React__namespace.createElement(
    ...
    React__namespace.createElement(
      "clipPath",
      { id: "baede272c8f74f3cdd7240e0ca31e670__a" },
      React__namespace.createElement("path", { d: "M0 0h14v22H0z" })
    )
  )
);
const ForwardRef = React.forwardRef(LabelPairedCircleInfoSmBoldIcon);
