...
const LabelPairedTriangleExclamationSmBoldIcon = ({ title, titleId, ...props }, ref) => React__namespace.createElement(
  "svg",
  ...
  React__namespace.createElement(
    ...
    React__namespace.createElement(
      "clipPath",
      { id: "94ebd871b89755cc937f4f2cf4005612__a" },
      React__namespace.createElement("path", { d: "M0 0h14v22H0z" })
    )
  )
);
const ForwardRef = React.forwardRef(LabelPairedTriangleExclamationSmBoldIcon);
