...
const LabelPairedCircleCheckSmBoldIcon = ({ title, titleId, ...props }, ref) => React__namespace.createElement(
  "svg",
  ...
  React__namespace.createElement(
    ...
    React__namespace.createElement(
      "clipPath",
      { id: "df8c822a116dbd5cf6d60534a1dc793e__a" },
      React__namespace.createElement("path", { d: "M0 0h14v22H0z" })
    )
  )
);
const ForwardRef = React.forwardRef(LabelPairedCircleCheckSmBoldIcon);
