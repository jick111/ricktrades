...
const LabelPairedTriangleExclamationSmRegularIcon = ({ title, titleId, ...props }, ref) => React__namespace.createElement(
  "svg",
  ...
  React__namespace.createElement(
    ...
    React__namespace.createElement(
      "clipPath",
      { id: "532744b1f8ffbb91565052af8ce00715__a" },
      React__namespace.createElement("path", { d: "M0 0h14v22H0z" })
    )
  )
);
const ForwardRef = React.forwardRef(LabelPairedTriangleExclamationSmRegularIcon);
