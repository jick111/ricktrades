...
const LabelPairedLoaderSmRegularIcon = ({ title, titleId, ...props }, ref) => React.createElement(
  "svg",
  { xmlns: "http://www.w3.org/2000/svg", width: 14, height: 22, viewBox: "0 0 14 22", role: "img", ref, "aria-labelledby": titleId, ...props },
  ...
  React.createElement(
    ...
    React.createElement(
      "clipPath",
      { id: "161dfe525a9f4b76b6b30fdbd48ff8e9__a" },
