 ...
 */
export declare const SideNote: ({ children, title, titleSize, className, actionClick, actionClassName, titleClassName, actionLabel, ...props }: PropsWithChildren<SideNoteProps>) => import("react").JSX.Element;
export {};
