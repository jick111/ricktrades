...
exports.MarketCryptocurrencyMkrusdIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketCryptocurrencyMkrusdIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("g", { clipPath: 'url(#69b43a2413fd135595788842e3efa2f0__a)' },
        React.createElement("path", { fill: '#0090FF', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
        React.createElement("path", { fill: 'url(#69b43a2413fd135595788842e3efa2f0__b)', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
        React.createElement("path", { fill: '#fff', d: 'M7.204 12.803V9.181l2.747 2.067v1.555h.7v-1.7a.41.41 0 0 0-.162-.326L7.158 8.269a.41.41 0 0 0-.655.327v4.207zm7.596 0V9.181l-2.747 2.067v1.555h-.7v-1.7a.4.4 0 0 1 .162-.326l3.331-2.507a.41.41 0 0 1 .656.326v4.207z' })),
    ...
    React.createElement("defs", null,
        React.createElement("linearGradient", { id: '69b43a2413fd135595788842e3efa2f0__b', x1: 11.001, x2: 11.001, y1: 2.001, y2: 19.999, gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#4FA89B' }),
            React.createElement("stop", { offset: 1, stopColor: '#6ACEBB' })),
        React.createElement("clipPath", { id: '69b43a2413fd135595788842e3efa2f0__a' },
            React.createElement("path", { fill: '#fff', d: 'M2.002 2.001H20v17.998H2.002z' })))));
exports.MarketCryptocurrencyMkrusdIcon = MarketCryptocurrencyMkrusdIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketCryptocurrencyMkrusdIcon);
