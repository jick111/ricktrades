...
exports.MarketCryptocurrencyEtcusdIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketCryptocurrencyEtcusdIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("g", { clipPath: 'url(#178ac694eae71f6af02103a1176bc198__a)' },
        React.createElement("path", { fill: '#0B8311', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
        React.createElement("path", { fill: '#fff', d: 'M6.834 11.603c1.468.78 3 1.596 4.184 2.228l4.15-2.228c-1.503 2.232-2.755 4.09-4.15 6.147-1.398-2.052-2.942-4.316-4.184-6.147m.16-.615 4.028-2.15L15 10.972l-3.974 2.152zm4.024-2.84-4.184 2.203L11 4.252l4.168 6.113z' }),
        React.createElement("path", { fill: '#ADCDAD', d: 'm11.018 13.83 4.15-2.227c-1.503 2.232-4.15 6.147-4.15 6.147zm.004-4.992L15 10.972l-3.974 2.152zm-.004-.69L11 4.253l4.168 6.113z' }),
        React.createElement("path", { fill: '#AECDAE', d: 'm6.993 10.988 4.03.33 3.976-.344-3.974 2.152z' }),
        React.createElement("path", { fill: '#5B9C5B', d: 'm11.023 11.318 3.976-.344-3.974 2.152z' })),
    ...
    React.createElement("defs", null,
        React.createElement("clipPath", { id: '178ac694eae71f6af02103a1176bc198__a' },
            React.createElement("path", { fill: '#fff', d: 'M2.002 2.001H20v17.998H2.002z' })))));
exports.MarketCryptocurrencyEtcusdIcon = MarketCryptocurrencyEtcusdIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketCryptocurrencyEtcusdIcon);
