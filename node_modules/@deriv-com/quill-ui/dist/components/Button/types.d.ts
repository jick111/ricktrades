...
import { TDefaultColor, TRegularSizesWithExtraLarge, TSemiRegularSizes } from '../../types.ts';
...
export interface IconButtonProps extends Omit<ButtonProps, "iconPosition" | "label" | "icon" | "ref"> {
    icon: ReactNode;
}
