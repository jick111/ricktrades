import { default as React, ComponentProps, ElementType } from 'react';
import { TGenericSizes } from '../../types.ts';
...
export declare const Typography: ({ children, as, centered, className, ...rest }: TypographyProps) => React.DOMElement<{
    size?: Extract<TGenericSizes, "lg" | "md" | "sm" | "xl">;
    bold?: boolean;
    italic?: boolean;
    underlined?: boolean;
