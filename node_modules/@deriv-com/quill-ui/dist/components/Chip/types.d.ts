import { DropdownItemProps } from '../Atom';
import { QuillIconComponent, TRegularSizes } from '../../types.ts';
...
export interface SelectableChipProps extends Omit<BaseChipProps, "isDropdownOpen" | "dropdown"> {
    className?: string;
}
