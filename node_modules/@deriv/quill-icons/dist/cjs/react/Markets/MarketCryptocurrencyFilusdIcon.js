...
exports.MarketCryptocurrencyFilusdIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketCryptocurrencyFilusdIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("g", { clipPath: 'url(#3771b6c7d71f6555f4c8345ae71c0f6f__a)' },
        React.createElement("path", { fill: '#0090FF', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
        React.createElement("path", { fill: '#fff', fillRule: 'evenodd', d: 'm11.892 10.131-.222 1.187 2.114.297-.149.556-2.076-.297c-.149.483-.223 1.002-.408 1.447-.186.519-.371 1.038-.594 1.52-.296.63-.816 1.076-1.52 1.187-.408.074-.853.037-1.187-.222-.111-.075-.223-.223-.223-.334 0-.149.075-.334.186-.408.074-.037.26 0 .37.037.112.111.223.26.297.408.223.297.52.334.816.111.334-.296.52-.704.63-1.112.223-.89.446-1.743.631-2.634v-.148l-1.965-.297.074-.556 2.04.297.26-1.15-2.115-.334.074-.593 2.188.297c.075-.223.112-.408.186-.594.185-.667.37-1.335.816-1.928.445-.594.964-.965 1.743-.927.334 0 .667.11.89.37.037.038.111.112.111.186 0 .148 0 .334-.111.445-.148.111-.334.074-.482-.074-.111-.112-.185-.223-.297-.334-.222-.297-.556-.334-.816-.074-.185.185-.37.445-.482.704-.26.78-.445 1.595-.704 2.411l2.04.297-.149.556z', clipRule: 'evenodd' })),
    ...
    React.createElement("defs", null,
        React.createElement("clipPath", { id: '3771b6c7d71f6555f4c8345ae71c0f6f__a' },
            React.createElement("path", { fill: '#fff', d: 'M2.002 2.001H20v17.998H2.002z' })))));
exports.MarketCryptocurrencyFilusdIcon = MarketCryptocurrencyFilusdIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketCryptocurrencyFilusdIcon);
