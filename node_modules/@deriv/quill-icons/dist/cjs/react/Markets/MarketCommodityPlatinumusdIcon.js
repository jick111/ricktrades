...
exports.MarketCommodityPlatinumusdIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketCommodityPlatinumusdIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("g", { clipPath: 'url(#793164d5919be8c9257417acc9402a11__a)' },
        React.createElement("path", { fill: '#E3EBF2', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
        React.createElement("path", { fill: '#EDF6FF', d: 'M16.738 4.067a9 9 0 0 0-1.251-.87L3.197 15.486q.385.664.87 1.251zM6.345 18.702a9 9 0 0 1-1.775-1.407L17.296 4.57a9 9 0 0 1 1.407 1.774zM8.974 19.77a9 9 0 0 1-.828-.233L19.538 8.145q.136.406.232.828z' }),
        React.createElement("path", { fill: '#B2B6BB', d: 'M18.312 11A7.312 7.312 0 1 1 3.69 11a7.312 7.312 0 0 1 14.623 0' }),
        React.createElement("path", { fill: '#A8A8A8', d: 'M11 18.312A7.312 7.312 0 0 0 17.46 7.57a14.53 14.53 0 0 0-9.889 9.888 7.3 7.3 0 0 0 3.43.853' }),
        React.createElement("path", { fill: '#8D8F95', d: 'M16.444 6.119A7.312 7.312 0 0 0 6.12 16.444 7.312 7.312 0 1 1 16.444 6.119' })),
    ...
    React.createElement("defs", null,
        React.createElement("clipPath", { id: '793164d5919be8c9257417acc9402a11__a' },
            React.createElement("path", { fill: '#fff', d: 'M2.002 2.001H20v17.998H2.002z' })))));
exports.MarketCommodityPlatinumusdIcon = MarketCommodityPlatinumusdIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketCommodityPlatinumusdIcon);
