...
exports.MarketCryptocurrencyOmgusdIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketCryptocurrencyOmgusdIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("path", { fill: '#101010', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
    React.createElement("path", { fill: '#fff', d: 'M7.958 11.001c0-.425.25-.744.67-.744s.672.315.672.743c0 .427-.252.743-.672.743s-.67-.316-.67-.742' }),
    React.createElement("path", { fill: '#fff', fillRule: 'evenodd', d: 'M7.82 7.818a4.5 4.5 0 1 1 6.362 6.364A4.5 4.5 0 0 1 7.82 7.818M7.552 11c0 .633.417 1.126 1.075 1.126.66 0 1.076-.497 1.076-1.126 0-.63-.417-1.127-1.076-1.127-.658 0-1.075.494-1.075 1.127m4.256 1.07h.375l.005-2.143h-.508l-.594 1.638-.594-1.638h-.508v2.143h.363v-1.51l.552 1.51h.358l.551-1.51zm2.257-.778c-.036.315-.264.46-.554.46h-.002c-.416 0-.649-.306-.649-.748 0-.413.205-.753.64-.753.285 0 .515.147.54.389h.407c-.055-.49-.426-.763-.934-.763-.717 0-1.051.552-1.051 1.14 0 .631.386 1.109.986 1.109.352 0 .549-.163.628-.3v.244h.37v-1.148h-.998v.37z', clipRule: 'evenodd' }),
...
exports.MarketCryptocurrencyOmgusdIcon = MarketCryptocurrencyOmgusdIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketCryptocurrencyOmgusdIcon);
