...
exports.MarketForexEurgbpIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketForexEurgbpIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("path", { fill: '#fff', d: 'M8 14a2 2 0 0 1 2-2h1.605L18 16.263V12h4v4.263L28.395 12H30a2 2 0 0 1 2 2v.404L26.606 18H32v4h-5.394L32 25.596V26a2 2 0 0 1-2 2h-1.606L22 23.737V28h-4v-4.263L11.606 28H10a2 2 0 0 1-2-2v-.404L13.394 22H8v-4h5.394L8 14.404z' }),
    React.createElement("path", { fill: '#F44336', d: 'M18.759 12v6.726H8v2.522h10.759V28h2.482v-6.752H32v-2.522H21.241V12z' }),
    React.createElement("path", { fill: '#F44336', d: 'm30.764 12.151-8.695 5.734h1.52l7.906-5.214c-.2-.224-.449-.403-.73-.52M31.72 27.023l-7.483-4.934h-1.52l8.423 5.554c.235-.163.433-.375.58-.62M9.198 27.833l8.71-5.744h-1.52l-7.906 5.213c.194.227.439.41.716.53M8.243 13.044l7.34 4.841h1.52l-8.31-5.48a2 2 0 0 0-.55.64' }),
...
exports.MarketForexEurgbpIcon = MarketForexEurgbpIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketForexEurgbpIcon);
