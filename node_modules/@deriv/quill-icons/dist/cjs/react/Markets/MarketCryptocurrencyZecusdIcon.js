...
exports.MarketCryptocurrencyZecusdIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketCryptocurrencyZecusdIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("path", { fill: '#F4B728', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
    React.createElement("path", { fill: '#231F20', d: 'M9.4 13.098v-.688l1.908-2.586H9.401v-.912h1.23V8.16h.755v.752h1.23V9.6l-1.908 2.588h1.908v.91h-1.23v.754h-.756v-.754z' }),
    React.createElement("path", { fill: '#231F20', fillRule: 'evenodd', d: 'M6.501 11c0-2.481 2.018-4.5 4.5-4.5 2.481 0 4.5 2.019 4.5 4.5s-2.019 4.5-4.5 4.5A4.504 4.504 0 0 1 6.5 11m.743 0A3.76 3.76 0 0 0 11 14.757 3.76 3.76 0 0 0 14.758 11 3.76 3.76 0 0 0 11 7.243 3.76 3.76 0 0 0 7.244 11', clipRule: 'evenodd' }),
...
exports.MarketCryptocurrencyZecusdIcon = MarketCryptocurrencyZecusdIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketCryptocurrencyZecusdIcon);
