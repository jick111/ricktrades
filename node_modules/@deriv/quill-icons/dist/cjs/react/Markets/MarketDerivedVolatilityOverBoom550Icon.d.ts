...
export declare const MarketDerivedVolatilityOverBoom550Icon: ({ iconSize, title, titleId, ...props }: QuillSvgProps & SVGRProps, ref: Ref<SVGSVGElement>) => React.JSX.Element;
