...
exports.MarketCryptocurrencyNeousdIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const MarketCryptocurrencyNeousdIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("path", { fill: '#00E599', d: 'M20 11a8.999 8.999 0 1 1-17.998 0A8.999 8.999 0 0 1 20 11' }),
    React.createElement("path", { fill: '#fff', d: 'M6.933 14.097v-6.02l4.3-1.577 3.834 1.374L10.84 9.43V15.5z' }),
    React.createElement("path", { fill: '#fff', d: 'M11.16 12.897V9.604l3.906-1.445.002 6.138zM12.019 20.438a9 9 0 0 0 .052 1.687h17.86a9 9 0 0 0 .051-1.687zM21 17.063v1.687h8.716a9 9 0 0 0-.621-1.687zM21 15.376h7.026a9 9 0 0 0-1.778-1.688H21zM12.45 23.812c.194.592.449 1.157.756 1.688h15.59q.462-.798.756-1.688zM14.466 27.187a9 9 0 0 0 2.175 1.687h8.72a9 9 0 0 0 2.175-1.687z' }),
...
exports.MarketCryptocurrencyNeousdIcon = MarketCryptocurrencyNeousdIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.MarketCryptocurrencyNeousdIcon);
