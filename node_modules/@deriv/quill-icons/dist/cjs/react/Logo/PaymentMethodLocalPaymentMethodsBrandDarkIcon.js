...
const PaymentMethodLocalPaymentMethodsBrandDarkIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 128 80', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("g", null,
        React.createElement("path", { fill: '#5DAF5D', d: 'M56.263 26.613 43.75 18.406c-1.138-.812-2.763-.487-3.575.732L25.388 41.4c-.163.163-.082.488.162.569l2.762 1.3 7.394-5.282c1.463-1.056 3.413-.893 4.794.244l.406.325c1.544 1.3 1.706 3.657.488 5.2l-8.938 11.782 3.331 2.437c1.22.813 2.763.487 3.575-.731l17.632-27.056c.812-1.22.487-2.763-.731-3.575M47.73 30.43c-.569.894-2.031 1.056-3.169.325s-1.624-2.112-.974-3.006c.568-.894 2.03-1.056 3.168-.325 1.056.731 1.544 2.113.975 3.006' }),
        React.createElement("path", { fill: '#fff', d: 'M44.563 30.756c1.137.732 2.6.57 3.168-.325.569-.893.081-2.275-.975-3.006-1.137-.731-2.6-.569-3.169.325-.65.894-.162 2.275.975 3.006' }),
    ...
    React.createElement("defs", null,
        React.createElement("clipPath", { id: 'a9ae2f05f3ff533a2b4a32ca7204b313__a' },
            React.createElement("path", { fill: '#fff', d: 'M8 17h53v46H8z' })))));
const ForwardRef = (0, react_1.forwardRef)(PaymentMethodLocalPaymentMethodsBrandDarkIcon);
