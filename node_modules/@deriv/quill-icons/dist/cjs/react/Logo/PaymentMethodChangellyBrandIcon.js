...
const PaymentMethodChangellyBrandIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 128 80', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
...
const ForwardRef = (0, react_1.forwardRef)(PaymentMethodChangellyBrandIcon);
