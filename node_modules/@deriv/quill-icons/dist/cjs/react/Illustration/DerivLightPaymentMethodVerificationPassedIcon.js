...
const DerivLightPaymentMethodVerificationPassedIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 96 116', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("g", { clipPath: 'url(#6879065db4a95380f88d569602aac782__a)' },
        ...
        React.createElement("path", { fill: '#4BB4B3', d: 'M72.99 116C85.7 116 96 105.703 96 93S85.699 70 72.99 70 49.98 80.298 49.98 93s10.302 23 23.01 23' }),
        React.createElement("path", { fill: '#fff', d: 'M71.38 100.38c-.247 0-.486-.085-.68-.24l-6.06-5a1.09 1.09 0 0 1-.15-1.51 1.07 1.07 0 0 1 1.51-.15l5.23 4.28 9.45-11.61a1.07 1.07 0 1 1 1.66 1.35L72.22 100a1.08 1.08 0 0 1-.73.39z' })),
    React.createElement("defs", null,
        React.createElement("clipPath", { id: '6879065db4a95380f88d569602aac782__a' },
            React.createElement("path", { fill: '#fff', d: 'M0 0h96v116H0z' })))));
const ForwardRef = (0, react_1.forwardRef)(DerivLightPaymentMethodVerificationPassedIcon);
