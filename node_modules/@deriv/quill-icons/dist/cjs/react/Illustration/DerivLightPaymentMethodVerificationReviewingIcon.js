...
const DerivLightPaymentMethodVerificationReviewingIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 96 116', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("g", { clipPath: 'url(#c263bf23af38bd807b4a1b3125bfc888__a)' },
        ...
        React.createElement("path", { fill: '#F26447', d: 'M74.578 116C86.39 116 96 106.383 96 94.563s-9.61-21.437-21.422-21.437-21.523 9.617-21.523 21.437S62.665 116 74.578 116' }),
        React.createElement("path", { fill: '#fff', d: 'M86.99 99.07H73.077c-.3 0-.5-.1-.7-.3s-.3-.4-.3-.7V83.142c0-.6.4-1.001 1-1.001s1.001.4 1.001 1.001v14.025h12.914c.6 0 1 .4 1 1.001s-.4.902-1 .902' })),
    React.createElement("defs", null,
        React.createElement("clipPath", { id: 'c263bf23af38bd807b4a1b3125bfc888__a' },
            React.createElement("path", { fill: '#fff', d: 'M0 0h96v116H0z' })))));
const ForwardRef = (0, react_1.forwardRef)(DerivLightPaymentMethodVerificationReviewingIcon);
